...
Todo aplikace v **čistém PHP 8.3 (OOP)** — bez frameworku a bez Composeru. Slouží jako codebase pro výukový díl o Claude Code slash příkazech a Skills. Detailní popis architektury je v `ARCHITEKTURA.md`.
